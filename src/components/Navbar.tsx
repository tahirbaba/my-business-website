    ...
    <nav className="w-full px-6 py-4 bg-gradient-to-r from-white/80 to-blue-200/60 dark:from-gray-900/60 dark:to-gray-800/60 backdrop-blur-md shadow-xl flex items-center justify-between transition-all duration-500 relative z-50 border-b border-indigo-100 dark:border-indigo-900">
      ...
      <div className="flex items-center space-x-3 text-gray-600 dark:text-gray-300 relative">
        ...
        {showSearch && (
          <div
            ref={searchRef}
            className="absolute top-14 right-0 w-64 bg-white dark:bg-gray-800 shadow-2xl rounded p-3 z-50 border border-indigo-100 dark:border-indigo-700"
          >
            <input
              type="text"
              placeholder="Search..."
        ...
        {showNotifications && (
          <div
            ref={notificationRef}
            className="absolute top-14 right-0 w-72 bg-white dark:bg-gray-800 shadow-2xl rounded p-4 z-50 border border-indigo-100 dark:border-indigo-700"
          >
        ...
        {showProfileMenu && (
          <div
            ref={profileRef}
            className="absolute top-14 right-0 w-48 bg-white dark:bg-gray-800 shadow-2xl rounded p-4 z-50 border border-indigo-100 dark:border-indigo-700 space-y-2"
          >
