...
Let’s build your online success together! 💡`,
  },
  {
    ...
    tags: ['OpenAI', 'LangChain', 'Streamlit', 'Chainlit', 'RAG', 'UV'],
    modalCTA: 'Explore AI Projects 🚀',
    modalLink: 'https://agentic-ai-trip-planner-app-2vfc.vercel.app/',
    modalContent: `
🚀 Built intelligent tools using OpenAI SDK with powerful NLP and reasoning.
🔗 Integrated LangChain and Chainlit for dynamic LLM workflows.
📊 Streamlit dashboards for real-time AI interaction.
📚 RAG used for smarter contextual outputs.
🧠 UV explored for web-based AI interfaces.
`,
  },
  {
    icon: Layers3,
    ...
    modalContent: `
🧠 Designed user flows using Figma, Framer, Adobe XD.
📐 High-fidelity responsive prototypes.
🎯 Accessibility, mobile-first layouts, transitions.
⚙️ Dev-ready with auto-layouts and components.
🚀 UX grounded in psychology & user behavior.
`,
  },
  {
    icon: Paintbrush,
    ...
    modalContent: `
🎨 Stunning graphics for marketing & identity.
🖼️ Designed logos, posters, brochures, socials.
🌈 Brand kits with fonts, palettes & icons.
📢 Visual storytelling for startups & campaigns.
💎 Every pixel speaks your brand voice.
`,
  },
];
