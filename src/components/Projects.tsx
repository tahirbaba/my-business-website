...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      className="w-full py-24 px-4 sm:px-6 md:px-10 lg:px-24 bg-gradient-to-br from-[#eaf1ff] via-[#f2f7ff] to-[#ddeaff] dark:from-[#0c1528] dark:via-[#121e35] dark:to-[#0e172c]"
    >
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <motion.h2
          ...
          className="text-center text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-white tracking-tight"
        >
          Our{' '}
          ...
          {filteredProjects.map((project, i) => {
            ...
            return (
              <motion.div
                ...
                className="relative bg-white/20 dark:bg-white/5 backdrop-blur-lg rounded-3xl border border-white/30 dark:border-white/10 p-5 overflow-hidden shadow-xl group hover:shadow-indigo-400 dark:hover:shadow-pink-600 transition-all duration-300"
              >
                {/* Decorative ring */}
                <div className="absolute inset-0 pointer-events-none rounded-3xl border border-transparent group-hover:border-indigo-400 group-hover:scale-[1.02] transition duration-300" />

                {/* Thumbnail */}
                <div className="relative h-36 w-full rounded-xl overflow-hidden mb-3 shadow-md">
                  <Image
                    src={firstImage}
                    alt={project.title}
                    fill
